...
if __name__ == "__main__":
    ...
    fileName1, attackInitiationStartTime, attackInitiationEndTime, attackInitiationTimeStep, attackStartValue, attackEndValue, attackValueStep, attackMaxDuration = main(expTypeName)
